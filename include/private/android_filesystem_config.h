...
static const struct fs_path_config android_files[] = {
    ...
    { 00644, AID_BLUETOOTH, AID_BLUETOOTH, 0, "system/etc/dbus.conf" },
    { 00644, AID_BLUETOOTH, AID_BLUETOOTH, 0, "system/etc/bluetooth/main.conf" },
    { 00644, AID_BLUETOOTH, AID_BLUETOOTH, 0, "system/etc/bluetooth/input.conf" },
    { 00644, AID_BLUETOOTH, AID_BLUETOOTH, 0, "system/etc/bluetooth/audio.conf" },
    { 00644, AID_BLUETOOTH, AID_BLUETOOTH, 0, "system/etc/bluetooth/network.conf" },
    { 00644, AID_NET_BT,    AID_NET_BT,    0, "system/etc/bluetooth/blacklist.conf" },
    { 00644, AID_SYSTEM,    AID_SYSTEM,    0, "system/etc/bluetooth/auto_pairing.conf" },
